! function(e) {
    ...
    e.MIDIjs = new Object
    if (A == "WebAudioAPI") {
      // We may be on a browser that suspends AudioContext until
      // user interacts with page, e.g. Chrome 71 and later.
      // The method defined below is intended to be bound to the
      // the page body click event to make sure the context is resumed.
      e.MIDIjs.resumeAudioContext = function(e) {
