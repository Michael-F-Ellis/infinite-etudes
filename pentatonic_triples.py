...
# pylint: disable=R,C
"""
Pentatonic-triples creates etudes for ear training based on the pentatonic scale.
"""
...
def shuffledTriples():
    ...
    triples = []
    for p in permutations((1,2,3,5,6), 3):
...
def etude(directives="K=E@ T=120", countin="z - - - |"):
    """ Return 60 lines of Tbon notation, one line for each possible triple."""
