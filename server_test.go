...
func TestGoodEtudeRequest(t *testing.T) {
	...
	testTable := []testcase{
		{
			url:      "http://" + testhost + "/etude/aflat/pentatonic/minor2/minor2/minor2/trumpet/steady/120/3",
			filename: "aflat_pentatonic_trumpet_steady_120_3.mid",
		},
		{
			url:      "http://" + testhost + "/etude/aflat/intervalpair/minor2/minor2/minor2/trumpet/steady/120/1",
			filename: "intervalpair_minor2_minor2_trumpet_steady_120_1.mid",
		},
	}
...
func TestVocalEtudeRequest(t *testing.T) {
	...
	var err error
	url := "http://" + testhost + "/etude/aflat/pentatonic/minor2/minor2/minor2/choir_aahs_tenor/advancing/120/3"
	resp, err := http.Get(url)
	if err != nil {
		t.Errorf("GET failed: %v", err)
		return
	...
	exp, _ := ioutil.ReadFile("aflat_pentatonic_choir_aahs_tenor_advancing_120_3.mid")
	got, _ := ioutil.ReadAll(resp.Body)
	if !bytes.Equal(got, exp) {
		t.Errorf("response didn't match the file content")
	}
...
func TestBadEtudeRequest(t *testing.T) {
	badRequests := []string{
		"/etude/c/pentatonic/minor2/minor2/minor2/trumpet/steady/120",            // no repeat count
		"/etude/hsharp/pentatonic/minor2/minor2/minor2/trumpet/steady/120/3",     // bad tonal center
		"/etude/c/schizotonic/minor2/minor2/minor2/trumpet/steady/120/3",         // bad pattern
		"/etude/c/interval/fermented2/minor2/minor2/trumpet/steady/120/3",        // bad interval1
		"/etude/c/intervalpairs/minor2/minor2/toxic2/trumpet/steady/120/3",       // bad interval2
		"/etude/c/pentatonic/minor2/minor2/toxic2/fromixhorn/steady/120/3",       // bad instrument
		"/etude/c/pentatonic/minor2/minor2/minor2/trumpet/jittery/120/3",         // bad rhythm
		"/etude/c/pentatonic/minor2/minor2/minor2/trumpet/steady/allaregretto/3", // bad tempo
	}
